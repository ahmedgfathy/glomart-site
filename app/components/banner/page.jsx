...
const Banner = () => {
      ...
      <div className=" absolute px-10 lg:px-10 z-20 flex flex-col gap-4">
        ...
        <div>
          <div className="hidden lg:flex justify-center ">
            <button className="py-2 px-5 w-[100px] rounded-tl-lg bg-[#2563eb] text-white">BUY</button>
            <button className="py-2 px-5  w-[100px] rounded-tr-lg  bg-black-600 text-white ">RENT</button>
 ...
 absolute w-full mt-2 bg-white border border-gray-200 rounded-lg shadow-lg max-h-60 overflow-y-auto z-10">
            ...
            <Grid container spacing={2} className="flex flex-wrap">
              ...
              <Grid item xs={12} sm={12} md={4} className="flex-1 flex justify-end">
                <button
